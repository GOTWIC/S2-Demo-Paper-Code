package src._02_oneColumnStringSearch.client;
...
public class Client02 extends Thread {
    ...
    // the fingerprintPrime  value i.e value of r which is taken as 43 in our case
    ...
    public Client02(String IP, int port, String[] data) {
        this.IP = IP;
        this.port = port;
        this.data = data;
    }
