...
public class server2 {
    ...
    // query string to get server data from database
    private static final String query_base_05 = " from " + Helper.getDatabaseName() + "." + Helper.getTableName() + "_SERVERTABLE2 where rowID > ";
    ...
    private static void doWork_05(String[] data) {
        ...
        result_05[querySize_05][0] = BigInteger.valueOf(2);
    }
