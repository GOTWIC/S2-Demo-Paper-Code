...
public class server3 {
    ...
    private static final String query_base2_04 = " from " + Helper.getDatabaseName() + "." + Helper.getTableName() + "_SERVERTABLE3 where rowID > ";
    ...
    private static void doWork_04(String[] data) throws IOException {
        ...
        result_04[resultDim][0] = BigInteger.valueOf(3);
    }
